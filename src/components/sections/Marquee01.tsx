...
export default function Marquee01() {
    ...
    const MarqueeItem = ({ text }: { text: string }) => (
        <div className="flex items-center gap-4 lg:gap-8 shrink-0">
            <div className="flex flex-col font-sugar-peachy font-black justify-center leading-[0] not-italic relative shrink-0 text-[#1a1a1a] text-[28px] md:text-[50px] lg:text-[60px] whitespace-nowrap">
