...
const DELAY_SHOW_TOOLTIP = 10000;  // 10s após carregar a página
const TOOLTIP_DURATION = 5000;     // 5s visível, depois fecha
...
export default function WhatsAppButton() {
    ...
    // Hover: mostra enquanto estiver com o mouse em cima, fecha imediatamente ao sair
