...
export default function HeroSectionV2B() {
    return (
        <section className="bg-[#fff6ee] relative w-full h-auto lg:h-[1085px] overflow-hidden pb-8 lg:pb-0" id="hero" data-name="Section - 1 V2 B">
            {/* --- Background Graphics --- */}
            ...
            <div className="relative lg:absolute lg:top-[120px] pt-[90px] lg:pt-0 left-0 lg:left-1/2 -translate-x-0 lg:-translate-x-1/2 w-full max-w-[1280px] flex flex-col items-center gap-[28px] md:gap-[46px] z-20 px-4 md:px-6 lg:px-0">
                ...
                <div className="flex flex-col items-center gap-[28px] w-full">
                    ...
                    <div className="font-dm-sans text-[#4c4d4f] text-[16px] sm:text-[18px] md:text-[24px] text-center leading-[1.2] md:leading-[1.1] flex flex-col gap-3 md:gap-4 max-w-full md:max-w-[850px] px-2 md:px-0">
                        <p>
